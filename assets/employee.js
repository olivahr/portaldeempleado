...
function ensureChromeOnce() {
  ...
  style.textContent = `
    ...
    .progress-hero{
      background:linear-gradient(135deg,rgba(29,78,216,.08) 0%,rgba(22,163,74,.08) 100%);
      border:1px solid rgba(229,234,242,.95);
      border-radius:20px;
      padding:24px;
      margin-bottom:20px;
    ...
    .progress-warehouse-grid{
      display:grid;
      grid-template-columns:repeat(2,1fr);
      gap:12px;
    }
    .progress-warehouse-item{
      background:#fff;
      border-radius:12px;
      padding:12px;
      border:1px solid rgba(229,234,242,.95);
    }
    .progress-warehouse-item-label{
      font-weight:900;
      font-size:10px;
      color:rgba(2,6,23,.50);
      text-transform:uppercase;
    ...
    @media (max-width: 420px){
      ...
      .progress-warehouse-grid{ grid-template-columns:1fr; }
    }
  `;
  document.head.appendChild(style);
...
// ===============================
// HOME (A-to-Z cards) - NOW DEFAULT ENTRY POINT
// ===============================
