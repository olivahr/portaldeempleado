...
function ensureChromeOnce() {
  ...
  style.textContent = `
    ...
    /* Shift Selection Enhanced Styles */
    .shift-info-badge{
      display:inline-flex;
      align-items:center;
      gap:6px;
    ...
    .shift-badge-early{ background:rgba(245,158,11,.12); color:#92400e; }
    .shift-badge-mid{ background:rgba(59,130,246,.12); color:#1e40af; }
    .shift-badge-late{ background:rgba(99,102,241,.12); color:#3730a3; }
    .shift-details-grid{
      display:grid;
    ...
    @media (max-width: 420px){
      ...
      .shift-details-grid{ grid-template-columns: 1fr; }
    }
  `;
  ...
  // iOS: prevent tap after scroll inside sheet
  (() => {
    const sh = document.getElementById("azMoreSheet");
    if (!sh) return;
  ...
  // FIX: More works always + overlay never blocks taps
  const azMoreOpen = () => {
    const ov = document.getElementById("azMoreOverlay");
    const sh = document.getElementById("azMoreSheet");
    if (!ov || !sh) return;
...
// ===============================
// ENHANCED SHIFT SELECTION - REALISTIC WAREHOUSE DATA
// ===============================
function renderShiftSelection(userData, saveUserPatch) {
  ...
  // Realistic position data based on warehouse/manufacturing operations
  const positions = [
    {
      key: "assembler",
      title: "Solar Panel Assembler",
      shortDesc: "Hands-on assembly line production",
      fullDesc: "Perform precision assembly of photovoltaic modules on automated production lines. Operate soldering equipment, laminators, and framing stations. Maintain quality standards while meeting production targets in a climate-controlled facility.",
      payRange: "$18.50 - $23.00/hr",
      type: "Direct Hire",
      physicalDemand: "Medium",
      scheduleType: "Fixed Shift",
      tags: ["Climate Controlled", "Entry Level", "Growth Path"]
    },
    {
      key: "material",
      title: "Material Handler / Warehouse",
      shortDesc: "Inventory movement and logistics",
      fullDesc: "Operate forklifts, pallet jacks, and automated guided vehicles (AGVs) to move raw materials and finished products. Manage inventory using RF scanners, load/unload trucks, and support just-in-time production schedules in a fast-paced distribution environment.",
      payRange: "$18.00 - $22.50/hr",
      type: "Direct Hire",
      physicalDemand: "High",
      scheduleType: "Fixed Shift",
      tags: ["Forklift Cert Required", "OT Available", "Team Environment"]
    },
    {
      key: "qc",
      title: "Quality Control Inspector",
      shortDesc: "Product testing and compliance",
      fullDesc: "Conduct electrical testing, visual inspections, and performance verification on solar panels using specialized equipment (EL testers, flash testers, IR cameras). Document defects, maintain ISO 9001 standards, and collaborate with production to resolve quality issues.",
      payRange: "$19.00 - $24.00/hr",
      type: "Direct Hire",
      physicalDemand: "Light-Medium",
      scheduleType: "Fixed Shift",
      tags: ["Technical Role", "Detail Oriented", "Advancement"]
    },
    {
      key: "maintenance",
      title: "Maintenance Technician I",
      shortDesc: "Equipment repair and preventive maintenance",
      fullDesc: "Perform troubleshooting, repair, and preventive maintenance on production equipment including conveyors, robotic arms, and vacuum systems. Basic electrical and mechanical work with senior technician support. 2+ years experience preferred.",
      payRange: "$22.00 - $28.00/hr",
      type: "Direct Hire",
      physicalDemand: "Medium-High",
      scheduleType: "Fixed Shift",
      tags: ["Technical", "Experienced", "Career Growth"]
    }
  ];

  // Realistic shift data with detailed breakdowns
  const shifts = [
    {
      key: "early",
      title: "Morning Shift (Day)",
      hours: "6:00 AM - 2:30 PM",
      icon: "sun",
      color: "early",
      details: {
        duration: "8.5 hrs (8 hrs paid + 30 min unpaid lunch)",
        breaks: "Two 15-minute paid breaks (9:00 AM & 1:00 PM)",
        lunch: "30-minute unpaid lunch at 11:30 AM",
        days: "Monday - Friday (Weekend OT optional)",
        peakSeason: "Mandatory OT possible Oct-Jan"
      },
      perks: [
        "Free parking - easiest access",
        "Cafeteria open full shift",
        "Best for childcare schedules",
        "Most training opportunities"
      ],
      considerations: "Early start requires reliable transportation. Public transit limited before 5:30 AM."
    },
    {
      key: "mid",
      title: "Afternoon Shift (Swing)",
      hours: "2:00 PM - 10:30 PM",
      icon: "clock",
      color: "mid",
      details: {
        duration: "8.5 hrs (8 hrs paid + 30 min unpaid lunch)",
        breaks: "Two 15-minute paid breaks (4:00 PM & 8:00 PM)",
        lunch: "30-minute unpaid lunch at 6:00 PM",
        days: "Monday - Friday (Weekend OT optional)",
        peakSeason: "Mandatory OT possible Oct-Jan"
      },
      perks: [
      ...
      considerations: "Evening commute may encounter traffic. Limited supervision after 6 PM."
    },
    {
      key: "late",
      title: "Night Shift (Graveyard)",
      hours: "10:00 PM - 6:30 AM",
      icon: "moon",
      color: "late",
      details: {
        duration: "8.5 hrs (8 hrs paid + 30 min unpaid lunch)",
        breaks: "Two 15-minute paid breaks (12:00 AM & 4:00 AM)",
        lunch: "30-minute unpaid lunch at 2:00 AM",
        days: "Sunday Night - Friday Morning",
        peakSeason: "Reduced OT requirements"
      },
      perks: [
        "Highest shift differential +$2.50/hr",
        "Quietest work environment",
        "Fastest promotion track",
        "Free lunch program (night shift)"
      ],
      considerations: "Significant adjustment to sleep schedule required. Health impact considerations."
    },
    {
      key: "weekend",
      title: "Weekend Shift",
      hours: "Fri 6:00 PM - Mon 6:00 AM",
      icon: "star",
      color: "late",
      details: {
        duration: "12 hrs/day, 3 days = 36 hrs (paid as 40)",
        breaks: "Three 20-minute paid breaks per shift",
        lunch: "Two 30-minute unpaid lunches",
        days: "Friday - Sunday (72 hours total)",
        peakSeason: "Fixed schedule, no OT surprises"
      },
      perks: [
        "Work 3 days, get paid for 40 hours",
        "4 consecutive days off weekly",
        "Highest shift differential +$3.00/hr",
        "Full benefits eligible"
      ],
      considerations: "Long shifts require stamina. Limited weekday availability for appointments."
    }
  ];

  setPage(
    "Shift Selection",
    "Review available positions and shifts. HR will confirm final assignment based on business needs.",
    `
      <div class="azCard" style="background:rgba(29,78,216,.04); border-color:rgba(29,78,216,.20);">
        <div style="display:flex; align-items:center; gap:10px; margin-bottom:8px;">
          ${azIcon("info")}
          <div style="font-weight:1000; font-size:13px; color:rgba(29,78,216,1);">How This Works</div>
        </div>
        <div class="muted" style="line-height:1.5; font-size:12px;">
          Select your preferred position and shift below. This is a <strong>preference request</strong> - 
          HR will review availability and confirm your assignment within 48 hours. Some shifts offer 
          differential pay. Weekend shifts require special approval.
        </div>
      </div>
      ...
      <div class="azCard">
        ${sectionHeader("Step 1: Select Position", "4 options")}
        <div style="display:flex;flex-direction:column;gap:12px;">
          ${positions.map(p => posCard(p, pos)).join("")}
        </div>
      </div>
      ...
      <div class="azCard">
        ${sectionHeader("Step 2: Select Shift", "4 options")}
        <div style="display:flex;flex-direction:column;gap:12px;">
          ${shifts.map(s => shiftCard(s, sh)).join("")}
        </div>
      </div>

      <div class="azCard" style="margin-top:14px;">
        ${sectionHeader("Your Selection Summary")}
        <div id="selectionSummary" style="background:rgba(2,6,23,.04); border-radius:12px; padding:12px;">
          <div class="muted" style="font-size:12px; text-align:center; padding:8px;">
            Select a position and shift above to see your summary
          </div>
        </div>
      </div>

      <button class="btn primary" id="btnShiftSave" type="button" style="margin-top:14px;width:100%;border-radius:16px; padding:14px; font-weight:1000;">
        Submit Preferences to HR
      </button>

      <div class="small muted" style="margin-top:10px;line-height:1.4; text-align:center;">
        By submitting, you confirm availability for your selected schedule. 
        Final assignment subject to operational requirements.
      </div>
    `
  );

  function posCard(p, selectedKey) {
    const selected = selectedKey === p.key;
    return `
      <label class="azCard" style="
        box-shadow:none;
        border:2px solid ${selected ? "rgba(22,163,74,.40)" : "rgba(229,234,242,.95)"};
        background:${selected ? "rgba(22,163,74,.04)" : "#fff"};
        margin:0;
        cursor:pointer;
        transition:all .15s ease;
      ">
        <input type="radio" name="pos" value="${escapeHtml(p.key)}" ${selected ? "checked" : ""} style="position:absolute; opacity:0;"/>
        
        <div style="display:flex;gap:12px;align-items:flex-start;">
          <div style="
            width:40px; height:40px; border-radius:12px; 
            background:${selected ? "rgba(22,163,74,.12)" : "rgba(2,6,23,.06)"};
            display:flex; align-items:center; justify-content:center;
            flex-shrink:0;
          ">
            ${selected ? azIcon("check") : azIcon("dots")}
          </div>
          
          <div style="flex:1; min-width:0;">
            <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:10px;">
              <div class="azCardTitle" style="font-size:14px;">${escapeHtml(p.title)}</div>
              <div style="font-weight:1000; font-size:12px; color:rgba(22,163,74,1);">${escapeHtml(p.payRange)}</div>
            </div>
            
            <div class="azCardSub" style="margin-top:6px; line-height:1.4;">${escapeHtml(p.fullDesc)}</div>
            
            <div class="position-meta">
              ${p.tags.map(tag => `<span class="position-meta-tag">${escapeHtml(tag)}</span>`).join("")}
            </div>

            ${selected ? `
              <div style="margin-top:10px; padding-top:10px; border-top:1px solid rgba(22,163,74,.20);">
                <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:8px; font-size:11px;">
                  <div>
                    <div style="font-weight:900; color:rgba(2,6,23,.50);">Type</div>
                    <div style="font-weight:1000; color:rgba(2,6,23,.85); margin-top:2px;">${escapeHtml(p.type)}</div>
                  </div>
                  <div>
                    <div style="font-weight:900; color:rgba(2,6,23,.50);">Physical</div>
                    <div style="font-weight:1000; color:rgba(2,6,23,.85); margin-top:2px;">${escapeHtml(p.physicalDemand)}</div>
                  </div>
                  <div>
                    <div style="font-weight:900; color:rgba(2,6,23,.50);">Schedule</div>
                    <div style="font-weight:1000; color:rgba(2,6,23,.85); margin-top:2px;">${escapeHtml(p.scheduleType)}</div>
                  </div>
                </div>
              </div>
            ` : ""}
  ...
  function shiftCard(s, selectedKey) {
    const selected = selectedKey === s.key;
    const badgeClass = s.color === "early" ? "shift-badge-early" : s.color === "mid" ? "shift-badge-mid" : "shift-badge-late";
    
    return `
      <label class="azCard" style="
        box-shadow:none;
        border:2px solid ${selected ? "rgba(29,78,216,.40)" : "rgba(229,234,242,.95)"};
        background:${selected ? "rgba(29,78,216,.04)" : "#fff"};
        margin:0;
        cursor:pointer;
        transition:all .15s ease;
      ">
        <input type="radio" name="shift" value="${escapeHtml(s.key)}" ${selected ? "checked" : ""} style="position:absolute; opacity:0;"/>
        
        <div style="display:flex;gap:12px;align-items:flex-start;">
          <div style="
            width:40px; height:40px; border-radius:12px; 
            background:${selected ? "rgba(29,78,216,.12)" : "rgba(2,6,23,.06)"};
            display:flex; align-items:center; justify-content:center;
            flex-shrink:0;
          ">
            ${azIcon(s.icon)}
          ...
          <div style="flex:1; min-width:0;">
            <div style="display:flex; justify-content:space-between; align-items:center; gap:10px; flex-wrap:wrap;">
              <div class="azCardTitle" style="font-size:14px;">${escapeHtml(s.title)}</div>
              <div class="shift-info-badge ${badgeClass}">
                ${s.key === "late" || s.key === "weekend" ? "+$2.50-3.00/hr" : s.key === "mid" ? "+$1.50/hr" : "Base Rate"}
              </div>
            </div>
            
            <div style="font-weight:1000; font-size:13px; color:rgba(2,6,23,.70); margin-top:4px;">
              ${escapeHtml(s.hours)}
            </div>
            ...
            ${selected ? `
              <div class="shift-details-grid">
                <div class="shift-detail-item">
                  <div class="shift-detail-label">Duration</div>
                  <div class="shift-detail-value">${escapeHtml(s.details.duration)}</div>
                </div>
                <div class="shift-detail-item">
                  <div class="shift-detail-label">Breaks</div>
                  <div class="shift-detail-value">${escapeHtml(s.details.breaks)}</div>
                </div>
                <div class="shift-detail-item">
                  <div class="shift-detail-label">Lunch</div>
                  <div class="shift-detail-value">${escapeHtml(s.details.lunch)}</div>
                </div>
                <div class="shift-detail-item">
                  <div class="shift-detail-label">Work Days</div>
                  <div class="shift-detail-value">${escapeHtml(s.details.days)}</div>
                </div>
              </div>

              <div style="margin-top:10px; padding-top:10px; border-top:1px solid rgba(229,234,242,.95);">
                <div style="font-weight:1000; font-size:11px; color:rgba(2,6,23,.50); margin-bottom:6px;">SHIFT PERKS</div>
                <div class="shift-perks-list">
                  ${s.perks.map(perk => `
                    <div class="shift-perk-item">
                      ${azIcon("check")}
              ...
              <div class="shift-warning-box">
                <div class="shift-warning-title">
                  ${azIcon("alert")}
                  Important Consideration
                </div>
                <div style="font-size:12px; color:rgba(2,6,23,.70); line-height:1.4;">
                  ${escapeHtml(s.considerations)}
                </div>
              </div>
            ` : ""}
          </div>
  ...
  function updateSummary() {
    const posVal = document.querySelector("input[name=pos]:checked")?.value;
    const shiftVal = document.querySelector("input[name=shift]:checked")?.value;
    
    const posData = positions.find(p => p.key === posVal);
    const shiftData = shifts.find(s => s.key === shiftVal);
    
    const summaryEl = document.getElementById("selectionSummary");
    if (!summaryEl) return;

    if (!posData && !shiftData) {
      summaryEl.innerHTML = `
        <div class="muted" style="font-size:12px; text-align:center; padding:8px;">
          Select a position and shift above to see your summary
        </div>
      ...
      <div style="display:flex; flex-direction:column; gap:10px;">
        ${posData ? `
          <div style="display:flex; justify-content:space-between; align-items:center;">
            <div>
              <div style="font-size:11px; font-weight:900; color:rgba(2,6,23,.50);">POSITION</div>
              <div style="font-weight:1000; font-size:13px; color:rgba(2,6,23,.85);">${escapeHtml(posData.title)}</div>
            </div>
            <div style="font-weight:1000; font-size:13px; color:rgba(22,163,74,1);">${escapeHtml(posData.payRange)}</div>
          </div>
        ` : `<div style="color:rgba(245,158,11,1); font-size:12px; font-weight:900;">⚠ Select a position</div>`}
        
        ${shiftData ? `
          <div style="display:flex; justify-content:space-between; align-items:center;">
            <div>
              <div style="font-size:11px; font-weight:900; color:rgba(2,6,23,.50);">SHIFT</div>
              <div style="font-weight:1000; font-size:13px; color:rgba(2,6,23,.85);">${escapeHtml(shiftData.title)}</div>
              <div style="font-size:12px; color:rgba(2,6,23,.60);">${escapeHtml(shiftData.hours)}</div>
            </div>
            <div style="font-weight:1000; font-size:13px; color:rgba(29,78,216,1);">
              ${shiftData.key === "late" || shiftData.key === "weekend" ? "+$2.50-3.00/hr" : shiftData.key === "mid" ? "+$1.50/hr" : "Base"}
            </div>
          </div>
        ` : `<div style="color:rgba(245,158,11,1); font-size:12px; font-weight:900;">⚠ Select a shift</div>`}
        
        ${posData && shiftData ? `
          <div style="margin-top:6px; padding-top:10px; border-top:1px solid rgba(2,6,23,.10);">
            <div style="font-size:11px; font-weight:900; color:rgba(2,6,23,.50);">ESTIMATED START</div>
            <div style="font-weight:1000; font-size:13px; color:rgba(2,6,23,.85);">
              Pending HR confirmation (typically 3-5 business days)
            </div>
          </div>
        ` : ""}
      </div>
  ...
  document.querySelectorAll("input[name=pos], input[name=shift]").forEach(input => {
    input.addEventListener("change", () => {
      // Re-render to show expanded details for selected items
  ...
  document.getElementById("btnShiftSave").onclick = async () => {
    ...
    if (!position || !shiftKey) {
      uiToast("Please select both a position and a shift preference.");
      return;
    }
    ...
    await saveUserPatch({ 
      ...
      steps, 
      stage: "footwear",
      shiftSelectedAt: new Date().toISOString()
    });
    
    uiToast("Preferences submitted to HR. Check notifications for confirmation.");
